...
class UNet_res(nn.Module):
    ...
    def forward(self, x, t, y=None):
        ...
        print("h4:", h4.shape)
        print("h:", h.shape)
#         h4: torch.Size([1, 256, 2, 2])
#         h: torch.Size([1, 128, 5, 5])
        ...
        print("h3:", h3.shape)
        print("h:", h.shape)
#         h3: torch.Size([1, 128, 5, 5])
#         h: torch.Size([1, 64, 10, 10])
...
if __name__ == '__main__':
    # 定义一个测试用的时间依赖评分网络
    model = UNet_res(marginal_prob_std=lambda t: torch.ones(t.shape[0]), embed_dim=128)
